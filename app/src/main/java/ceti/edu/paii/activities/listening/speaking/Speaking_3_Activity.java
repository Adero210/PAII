...
public class Speaking_3_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recordpause = findViewById(R.id.pause_recorder_activity_speaking_3);
        ...
        record.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkPermissionFromDivice()) {
                    ...
                    Toast.makeText(Speaking_3_Activity.this, "Recording...",
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (1==3) {
                    ...
                    mediaPlayer.start();
                    Toast.makeText(Speaking_3_Activity.this, "Playing...",
                            Toast.LENGTH_SHORT).show();
